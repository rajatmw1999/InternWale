    ...
    const extractJobs= async(url)=>{
        ...
        if(jobData.length<1){
          ...
          //next url to call
            ...
            let nextUrl;
            if(str.charAt(0)=='m'){
              nextUrl= "https://careers.cognizant.com/global/en/search-results?".concat("from=50&s=1&").concat("m=3&location=Bangalore%2C%20Karnataka%2C%20India")
            }else{
              let sub= parseInt(str.substring(str.indexOf('=')+1,str.indexOf('&')));
              nextUrl="https://careers.cognizant.com/global/en/search-results?from=".concat(sub+50).concat("&s=1&m=3&location=Bangalore%2C%20Karnataka%2C%20India");
            }
      ...
      const url="https://careers.cognizant.com/global/en/search-results?m=3&location=Bangalore%2C%20Karnataka%2C%20India"
