...
async function scraper() {
                    ...
                    let jobs = [];
                      ...
                      jobElms.forEach((job) => {
                        ...
                        try {
                            ...
                            jobJson.description="mobile developers may apply";
          ...
          await page.goto('https://www.hirist.com/c/filter/mobile-applications-jobs-in-any%20location-5-0-1-0-1.html?ref=homepagecat',{waitUntil:"networkidle2"});
