...
async function scraper() {
                    ...
                    let jobs = [];
                      ...
                      jobElms.forEach((job) => {
                        ...
                        try {
                            ...
                            jobJson.description="People interested in devOps may apply";
          ...
          await page.goto('https://www.hirist.com/c/filter/devops-jobs-in-any%20location-8-0-1-0-1.html?ref=topnavigation',{waitUntil:"networkidle2"});
