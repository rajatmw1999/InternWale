...
async function scraper() {
                    ...
                    let jobs = [];
                      ...
                      jobElms.forEach((job) => {
                        ...
                        try {
                            ...
                            jobJson.description="People interested in Data Science may apply";
          ...
          await page.goto('https://www.hirist.com/c/filter/analytics--data-science-jobs-in-any%20location-7-0-1-0-1.html?ref=topnavigation',{waitUntil:"networkidle2"});
