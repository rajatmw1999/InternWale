...
async function scraper() {
                    ...
                    let jobs = [];
                      ...
                      jobElms.forEach((job) => {
                        ...
                        try {
                            ...
                            jobJson.description="People looking for internships may apply";
          ...
          await page.goto('https://www.hirist.com/k/filter/internship-jobs-in-any%20location-1331-0-0-0-1.html?ref=topnavigation&pref=internship',{waitUntil:"networkidle2"});
