...
async function scrapper() {
  ...
  const link = `https://internshala.com/internships/3d%20printing,animation,cad%20design,cinematography,creative%20design,design,fashion%20design,film%20making,game%20development,graphic%20design,media,motion%20graphics,photography,ui%2Fux,video%20making%2Fediting,videography-internship`;
  let i = 1;
  while (i <= 8) {
