...
async function scrapper() {
  ...
  const link = `https://internshala.com/internships/3d%20printing,aerospace,industrial%20and%20production%20engineering,industrial%20design,instrumentation%20and%20control%20engineering,mechanical,mechatronics-internship`;
  let i = 1;
  while (i <= 2) {
