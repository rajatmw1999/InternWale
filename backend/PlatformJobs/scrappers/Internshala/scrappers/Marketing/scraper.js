...
async function scrapper() {
  ...
  const link = `https://internshala.com/internships/analytics,blogging,brand%20management,digital%20marketing,facebook%20marketing,market%2Fbusiness%20research,marketing,social%20media%20marketing-internship`;
  let i = 1;
  while (i <= 8) {
